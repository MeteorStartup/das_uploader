...
#    console.log("child process exited with code #{code}}")
  ...
  unless CollectionServices.findOne()
    ...
    svcInfo.DB정보 = {
      DB이름: 'PYEONGCHANG'      #DB 별명
      DB접속URL: 'mysql://152.99.170.178:3306/RFC3'   #jdbc:mysql://14.63.225.39:3306/das_demo?characterEncoding=UTF8
      DBMS종류: 'MySQL'    #MsSQL/MySQL/Oracle
      DB_IP: '152.99.170.178'
      DB_PORT: '3306'
      DB_DATABASE: 'RFC3'  #DB name (or SID)
      DB_ID: 'root'       #ID
      DB_PW: 'happy$700*pc'
    }
